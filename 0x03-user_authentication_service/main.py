...
This script contains a series of integration tests for the user authentication service.
It tests various functionalities such as user registration, login, profile retrieval,
password reset, and password update. The tests are performed using the `requests` library
to send HTTP requests to the user authentication service API.

The tests cover both successful scenarios and error handling, asserting the expected
