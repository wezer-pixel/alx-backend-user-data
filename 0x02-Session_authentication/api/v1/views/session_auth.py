...
def login() -> Tuple[str, int]:
    ...
    If the email or password is missing or incorrect, appropriate error messages
    are returned. If the login is successful, a session ID is created and stored
    as a cookie.

    Returns:
        A tuple containing a JSON representation of a User object and an HTTP status code.
    """
