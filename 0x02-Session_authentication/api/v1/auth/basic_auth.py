...
class BasicAuth(Auth):
    ...
    It includes methods for extracting and decoding the Base64 part
    of the Authorization header, extracting user credentials from
    the decoded header, retrieving a user object based on the
    credentials, and retrieving the current user from a request.
    ...
    Methods:
        ...
        extract_user_credentials(decoded_base64_authorization_header: str) -> Tuple[str, str]:
